...
function Allactivities() {
  ...
  const Deletehandler = async (id) => {
    ...
    try {
        await axios.delete('/api/activites/deleteuploadedfile/' + id,{ timeout: 1000 });
                    ...
                    <tbody>
                      ...
                      {displayedItems.map((user, index) => (
                        <tr >
                          ...
                          <td>{user.title}</td>
                          <td><img src={`/activities/images/` + user.image} style={{ width: '50px', height: '50px' }} alt={user.image} /></td>
                        ...
                        <td>{user.check == "true" ? 'check' : 'uncheck'}</td>
                          ...
                          <td>
                            <Link to={`/Updates/Updateactivity/${user._id}`} className='btn btn-primary'>Edit Record</Link>
