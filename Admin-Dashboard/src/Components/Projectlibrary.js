...
const Projectlibrary = () => {
    ...
    const  AddCategory =(e) =>{
        ...
        console.log(datacate)
            ...
            axios.post('/api/projectlibrary/projectlibrary',datacate)
            .then(response => {
                        ...
                        <div className='k' style={{width:'60%',marginLeft:'20%',marginTop:'5%'}}>
                            ...
                            <div class="form-item">
                                    ...
                                    <input type="text" className="form-control" id="projectTitle" name="name"
                                        placeholder="Enter project title" onChange={e => setprojectlib(e.target.value)} required />
                                </div>
                                ...
                                <br/>
                                <input type="button" class="btn btn-primary" value='Add Category' onClick={AddCategory} />
                            </form>
                        </div>
