...
function Projects() {
    ...
    const Adduser = async (e) => {
        e.preventDefault();
        try {
          console.log(title, shortdescription, imageupload, longdescription, check, approve)
          ...
          if (!title) {
            ...
            toast.warning("Select One Image");
            ...
            // Send the data
            const response = await axios.post('/api/project/uploadfiles', formData, {  timeout: 2000 });
                                    ...
                                    <form id="Add-project-from">
                                        ...
                                        <div class="from-item">
                                            ...
                                            <input type="file" className="form-control form-control-file" id="projectImage"
                                                name="file1" onChange={e => setImageUpload(e.target.files[0])} required />
                                        </div>
                                        ...
                                        <br />
                                        <div class="from-item">
                                            <input type="button" className="btn btn-primary form-control" onClick={Adduser} value={'Add Project'} />
                                        </div>
