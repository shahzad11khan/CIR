...
function Calender() {
    ...
    const Addcalender = async (e) => {
        ...
        try {
            ...
            console.log(dataa);
            const response = await axios.post('/api/calender/addcalender', dataa, { timeout: 3000 });
                                    ...
                                    <form id="Add-project-from">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <input type="text" className="form-control" id="countrySelect" name="countrySelect"
                                                placeholder="Country" onChange={e => setselectcountry(e.target.value)} required />
                                        </div>
                                        {/* <div class="from-item">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <input type="text" className="form-control" id="citiesDropdown" name="select"
                                                placeholder="Country" onChange={e => setselectcity(e.target.value)} required />
                                        </div>
                                        {/* <div class="from-item">
                                        ...
                                        <br />
                                        <div class="from-item">
                                            <input type="submit" className="btn btn-primary form-control" onClick={Addcalender} value='Add Calender' />
                                        </div>
