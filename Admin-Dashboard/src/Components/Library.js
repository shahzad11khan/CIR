...
function Library() {
    ...
    const AddLibrary = async (e) => {
        ...
        try {
            ...
            if (!title || !shortdescription || !selectedOptions || !nature || !selectvalues || !file || !image || fileName.includes(' ')) {
            ...
            formData.append('longdescriotion', longdescription);

            const response = await axios.post('/api/libraryItem/postlibrary', formData, { timeout: 15000 });
    ...
    //       } else if(!title || !shortdescription || !selectedOptions || !nature || !selectvalues || !file || !image || fileName.includes(' ')){
    //         toast.warning("Please the filed...")
    //     }
    //     else{
    //     const formData = new FormData();
    ...
    //     formData.append('longdescriotion', longdescription);
    //     axios.post('/api/libraryItem/postlibrary', formData)
    //         .then(response => {
    //             console.log('Data sent successfully', response.data);
    //             // toast.success("Library Added Successfully")
    //         })
    //         .catch(error => {
    //             console.error('Error sending data', error);
    //             // toast.success("Library Not Added")
                    ...
                    <div id="content-wrapper" className="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div className="container">
                                ...
                                {/* main contents */}
                                <div id='k' style={{ width: '90%', marginLeft: '10%', marginTop: '1px' }}>
                                    ...
                                    <form id="Add-project-from">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name='title' placeholder="Enter title" onChange={e => setTitle(e.target.value)} required />
                                        </div>

                                        {/*  Short Description  */}
                                        <div class="form-group">
                                            <label class="from-label" for="shortDescription">Author</label>
                                            <input type="text" class="form-control" id="shortDescription" name='shortdescription' placeholder="Enter short description" onChange={e => setShortDescription(e.target.value)} required />
                                        </div>
                                        ...
                                        <div className="Register_from-item">
                                            ...
                                            <select class="form-control selectpicker" name='selectcategory' onChange={handleSelectChange} data-live-search="true" size={1}>
                                            <option selected>Select </option>
                                        ...
                                        <div class="Register_from-item">
                                            ...
                                            <select class="form-control" name='selectnature' onChange={e => setNature(e.target.value)} >
                                                <option selected>Select </option>

                                                {
                                                    nnature.map((natu) => {
                                                        return (
                                                            ...
                                                            <option value={natu.name}>{natu.name}</option>
                                                        )
                                                    })
                                                }
                                            </select>
                                        ...
                                        <div class="Register_from-item">
                                            ...
                                            <select class="form-control" name='selectproject' onChange={e => setProject(e.target.value)} >
                                                <option selected>Select </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="file" onChange={e => setFile(e.target.files[0])} required />
                                        </div>

                                        {/* Image Input  */}
                                        <div class="form-group">
                                            <label class="from-label" for="image" >Image</label>
                                            <input type="file" class="form-control" id="image" onChange={e => setImage(e.target.files[0])} required />
                                        </div>
                                        ...
                                        {/* Submit Button  */}
                                        <button type="submit" class="btn btn-primary form-control" onClick={AddLibrary}>Submit</button>
