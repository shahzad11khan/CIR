    ...
    const Adduser = async (e) => {
        ...
        if (!date) {
            ...
            if (fileName.includes(' ')) {
                ...
                const data= {date, title, shortdescription, imageupload, longdescription};
                ...
                const response = await axios.post('/api/news/uploadnews', formData, { timeout: 1000 });
            ...
            if (error.code === 'ECONNABORTED') {
                ...
                toast.warning("News added successfully")
                nav('../allnews')
                // window.location.reload();
                                ...
                                <div className='K' style={{ width: '70%', marginLeft: '10%' }}>
                                    ...
                                    <form id="Add-project-from">
                                        <div class="form-item">
                                            ...
                                            <input type="date" className="form-control" id="projectTitle" name="date" dateFormat="MM/dd/yyyy"
                                                placeholder='select date' onChange={e => setdate(e.target.value)} required />
                                        </div>
                                        <div class="form-item">
                                        ...
                                        <div id="metadata">
                                            ...
                                            <input type="file" id="metaImage" name="metaimage" onChange={e => setmetaImageUpload(e.target.files[0])} hidden />
                                        ...
                                        <div class="from-item">
                                            <button type="submit" className="btn btn-primary form-control" onClick={Adduser}> Add Project</button>
