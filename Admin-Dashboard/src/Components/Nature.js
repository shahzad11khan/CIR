...
const nav=useNavigate();
  ...
  const  Addnature =(e) =>{
    ...
    console.log(datacate)
        ...
        axios.post('/api/nature/natures',datacate)
        .then(response => {
                           ...
                           <Top/>
                            ...
                            <div className="container-fluid"> 
                              ...
                              <div className='k' style={{width:'60%',marginLeft:'20%',marginTop:'5%'}}>
                                    <form>
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Add New Nature</label>
                                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name='name' onChange={e=>setNature(e.target.value)} required />
                                        ...
                                        <input type="button" class="btn btn-primary" value='Add Naute' onClick={Addnature}/>
                                    </form>
                                </div>
