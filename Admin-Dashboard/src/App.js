...
function App() {
  return (
    ...
    <Route path='/' element={<Login/>}/>
      ...
      <Route path='/Updates/Updateactivity/:id' element={<Updateactivity/>}/>
      ...
      <Route path='/Updates/Updatecategory/:id' element={<Updatecategory/>}/>
      ...
      <Route path='/Updates/UpdateCalender/:id' element={<UpdateCalender/>}/>

      <Route path='/projectlib' element={<Projectlib/>}/>
      <Route path='/allprojectlib' element={<Allprojectforlib/>}/>
      <Route path='/Updates/Updateprojectlib/:id' element={<Updateprojectlib/>}/>

      <Route path='/superadmin' element={<Superadmin/>}/>
      <Route path='/Updates/Updatedbysuperadmin/:id' element={<Updatedbysuperadmin/>}/>
      ...
      <Route path='/Updates/Updatepartners/:id' element={<Updatepartners/>}/>
